...
def validate_remote_url(url: str) -> str:
    ...
    Only HTTPS on the standard port is accepted. The hostname is resolved and
    every returned address is checked to prevent access to local, private,
    link-local, multicast, reserved, or unspecified networks.

    A hostname allowlist or signed object-storage URL is still preferable for
    deployments exposed to untrusted users.
    """
