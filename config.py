...
PDF_BATCH_SIZE = get_int("PDF_BATCH_SIZE", 5)
MAX_PDF_BATCH_SIZE = get_int("MAX_PDF_BATCH_SIZE", 20)
MAX_BATCH_RETRIES = get_int("MAX_BATCH_RETRIES", 2)
BATCH_RETRY_BACKOFF_SECONDS = get_int(
    "BATCH_RETRY_BACKOFF_SECONDS",
    2,
)
MAX_BATCH_RETRY_BACKOFF_SECONDS = get_int(
    "MAX_BATCH_RETRY_BACKOFF_SECONDS",
    30,
)
MAX_BATCH_DURATION_SECONDS = get_int(
...
for name, value in {
    ...
    "MAX_PDF_BATCH_SIZE": MAX_PDF_BATCH_SIZE,
...
if PDF_BATCH_SIZE > MAX_PDF_BATCH_SIZE:
    raise ValueError("PDF_BATCH_SIZE cannot exceed MAX_PDF_BATCH_SIZE.")

if BATCH_RETRY_BACKOFF_SECONDS > MAX_BATCH_RETRY_BACKOFF_SECONDS:
    raise ValueError(
